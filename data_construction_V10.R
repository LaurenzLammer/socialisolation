...
df <- df[,c("subject", "fu", "age", "age_base", "age_change", "sex", "LSNS_sum", "LSNS_base", "LSNS_change", "HCV",
            ...
            "BMI", "hypertension", "diabetes", "education", "CES.D", "TICS_sum", "pandemic", "FS_usable")]
...
write.table(qdec1, "/data/pt_life/LLammer/Analysis/Preprocessing/long_qdec1.dat", 
            row.names = F, quote = F, sep = " ")
write.table(qdec2, "/data/pt_life/LLammer/Analysis/Preprocessing/long_qdec2.dat", 
            row.names = F, quote = F, sep = " ")
