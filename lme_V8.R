...
write.csv(coeff, file = "/data/pt_life/ResearchProjects/LLammer/Results/coefficients/HCV_on_LSNS_base:age_change_model1.csv")
...
write.csv(vifres, file = "/data/pt_life/ResearchProjects/LLammer/Results/VIFs/HCV_on_LSNS_base:age_change_model1.csv")
...
png(filename = "/data/pt_life/ResearchProjects/LLammer/Results/diag_plots/HCV_on_LSNS_base:age_change_model1.png")
...
write.csv(stab_results$summary, file = "/data/pt_life/ResearchProjects/LLammer/Results/model_stab//HCV_on_LSNS_base:age_change_model1.csv")
...
fastlme <- function(poi = "LSNS_base", dv, model = 1){
  ...
  write.csv(vifres,
            file = paste0("/data/pt_life/ResearchProjects/LLammer/Results/VIFs/", dv, "_on_", poi, "_model", model, ".csv"))
  sres <- summary(res)
  coeff <- as.data.frame(sres$coefficients)
  CI <- as.data.frame(confint.merMod(res))
  coeff <- merge(coeff, CI, all = T, by="row.names")
  ...
  coeff$n_individual <- ngrps(res)
  write.csv(coeff, 
            file = paste0("/data/pt_life/ResearchProjects/LLammer/Results/coefficients/", dv, "_on_", poi, "_model", model, ".csv"))
  png(filename = paste0("/data/pt_life/ResearchProjects/LLammer/Results/diag_plots/", dv, "_on_", poi, "_model", model, ".png"))
  diagnostics.plot(res)
  dev.off()
  stab_results <- glmm.model.stab(res)
  write.csv(stab_results$summary, 
            file = paste0("/data/pt_life/ResearchProjects/LLammer/Results/model_stab/", dv, "_on_", poi, "_model", model, ".csv"))
  pval_res <- as_lmerModLmerTest(res)
...
write.csv(vif_tresh_check, file = "/data/pt_life/ResearchProjects/LLammer/Results/VIFs/threshold_check.csv")
...
write.csv(stab_warnings, file = "/data/pt_life/ResearchProjects/LLammer/Results/model_stab/warnings_check.csv")
...
write.csv(pvals, file = "/data/pt_life/ResearchProjects/LLammer/Results/pvals/overview.csv")
...
write.csv(BF, file = "/data/pt_life/ResearchProjects/LLammer/Results/bayes_factor/bayes_factors.csv")

save.image("/data/pt_life/ResearchProjects/LLammer/Results/Workspace/workspace2.RData")
