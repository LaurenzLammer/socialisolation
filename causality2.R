...
summary(fitBLCS2, fit.measures=TRUE, standardized=TRUE, rsquare=TRUE)
...
summary(fitBLCS3, fit.measures=TRUE, standardized=TRUE, rsquare=TRUE)
...
summary(fitBLCS4, fit.measures=TRUE, standardized=TRUE, rsquare=TRUE)

semPaths(fitBLCS, layout = "circle2", intercepts = F, residuals = F ,sizeMan = 10, sizeLat = 12, nCharNodes = 0, color = "white", 
         edge.color = c("black", "black","black","black","blue","black","blue","black","black","black"), no)
