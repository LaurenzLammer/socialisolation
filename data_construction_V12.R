...
TMT <- read_excel("/data/pt_life/ResearchProjects/LLammer/Data/data/Followup/pv573/PV0573_T00041_NODUP.xlsx")
CERADa <- read_excel("/data/pt_life/ResearchProjects/LLammer/Data/data/Followup/pv573/PV0573_T00042_NODUP.xlsx")
CERADb <- read_excel("/data/pt_life/ResearchProjects/LLammer/Data/data/Followup/pv573/PV0573_T00044_NODUP.xlsx")
radio_fu <- read.csv("/data/pt_life/ResearchProjects/LLammer/Data/latest_radio_assessment.csv")
MRI_info_fu <- read_excel("/data/pt_life/ResearchProjects/LLammer/Data/data/Followup/pv573/PV0573_T01158_NODUP.xlsx")
TICS <- read_excel("/data/pt_life/ResearchProjects/LLammer/Data/data/Followup/pv573/PV0573_T00384_NODUP.xlsx")
...
# calculate mean and within scores of LSNS as an alternative to bae & change
...
#load aseg data
aseg <- read.table("/data/pt_life/ResearchProjects/LLammer/Data/aseg_stats.txt", header = T)
...
df <- df[,c("subject", "fu", "age", "age_base", "age_change", "sex", "LSNS_sum", "LSNS_base", "LSNS_change", "LSNS_mean", 
            "LSNS_within", "HCV", "memo", "exfunct", "procspeed", "outlier_HCV", "outlier_exfunct", "outlier_memo", 
            "outlier_procspeed", "BMI", "hypertension", "diabetes", "education", "CES.D", "TICS_sum", "pandemic", "FS_usable")]
